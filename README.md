...
---
<details>
<summary>Вектора на самостоятельное (углубленное) изучение</summary>

4. **Закрепление доступа**
...
6. Выход за рамки демилитаризованной зоны (ДМЗ) и ограничений сети
7. Проброс трафика в другие сегменты
8. Разведка в локальной сети
