...
6. Захват WPA Handshake - одна из самых популярных и широкоприменяемых атак.
  ...
  Для захвата рукопожатия используется команда следующего вида: `sudo airodump-ng -c КАНАЛ --bssid MAC_АДРЕС -w ФАЙЛ ИНТЕРФЕЙС` 
