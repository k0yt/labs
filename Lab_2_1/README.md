...
WPA-handshake прилетает от клиента во втором пакете рукопожатия (EAPOL М2). Задача атакующего - набрать таких handshake, используя подвижность или неприметность. После чего набранные handshake могут быть подвергнуты брутфорсу
...
![Правильное назначение каналов для точек доступа](channels.png)
...
- Атаки которые могут проводиться без подключенных к точке пользователей:
    ...
    9. DragonBlood
    10. Продвинутые корпоративные атаки – 802.1x, EAP, LEAP, PEAP, EAP-TTLS
