...
> Если есть желание понять, как работает аутентификация с сервером RADIUS в корпоративных сетях по стандарту 802.1X, то читайте в приложенных материалах главу 3.3.1 Технологии современных беспроводных сетей Wi-Fi.pdf под общей редакцией А.В. Пролетарского
